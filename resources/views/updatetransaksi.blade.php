          ...
          <div class="col-12 grid-margin stretch-card">
               <div class="card">
                    <div class="card-body">
                         ...
                         <form class="forms-sample" action="{{ url('transaksi/update_data',$transaksi->id) }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="text" name="quantity" value="{{ $transaksi->quantity }}" class="form-control" id="exampleInputCity1" placeholder="input stock">
                              </div>
                              <div class="form-group">
                                   <label for="exampleInputCity1">Payment</label>
                                   <input type="text" name="payment" value="{{ $transaksi->payment }}" class="form-control" id="exampleInputCity1" placeholder="input stock">
                              </div>
                              <div class="mt-3"><img src="" id="output" alt=""></div>
                              <button type="submit" class="btn btn-primary me-2">Submit</button>
                              <a href="/transaksi"><button type="button" class="btn btn-light">Back</button></a>
                         </form>
                    </div>
               </div>
          </div>

  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="index.html"><img src="{{ asset('template/assets/images/logo.png') }}" alt="logo" style="height: 160px; width: 180px;"/></a>
        <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="{{ asset('template/assets/images/logos.png') }}" alt="logo" style="width: 200px; height: 200;"/></a>
      </div>
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          <a class="nav-link {{ ($title === "table") ? 'active' : '' }}" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
            <span class="menu-icon">
